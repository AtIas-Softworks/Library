...
local themes = {
	...
	['Function'] = {
		['Toggle'] = {
			...
			['True'] = {
				['Toggle Background'] = Color3.fromRGB(0, 130, 190),
				['Toggle Value'] = Color3.fromRGB(0, 200, 255),
			},
			['False'] = {
				['Toggle Background'] = Color3.fromRGB(28, 28, 35),
				['Toggle Value'] = Color3.fromRGB(35, 35, 42),
			}
		},
		['Label'] = {
			['Background'] = Color3.fromRGB(20, 20, 28),
		...
		['Dropdown'] = {
			['Background'] = Color3.fromRGB(20, 20, 28),
			['Value Background'] = Color3.fromRGB(15, 15, 20),
			['Value Stroke'] = Color3.fromRGB(0, 200, 255),
			['Dropdown Select'] = {
				['Background'] = Color3.fromRGB(15, 15, 20),
				['Search'] = Color3.fromRGB(25, 25, 32),
		...
		['Slider'] = {
			...
			['Value Background'] = Color3.fromRGB(15, 15, 20),
			['Value Stroke'] = Color3.fromRGB(0, 200, 255),
			['Slider Bar'] = Color3.fromRGB(0, 130, 190),
			['Slider Bar Value'] = Color3.fromRGB(0, 200, 255),
			['Circle Value'] = Color3.fromRGB(255, 255, 255)
		},
		['Code'] = {
			...
			['Background Code'] = Color3.fromRGB(40, 50, 60),
			['Background Code Value'] = Color3.fromRGB(28, 35, 45),
			['ScrollingFrame Code'] = Color3.fromRGB(0, 200, 255)
		},
		['Button'] = {
			['Background'] = Color3.fromRGB(20, 20, 28),
			['Click'] = Color3.fromRGB(0, 200, 255)
		},
		['Textbox'] = {
			['Background'] = Color3.fromRGB(20, 20, 28),
			['Value Background'] = Color3.fromRGB(15, 15, 20),
		...
		['Color Picker'] = {
			...
			['Color Select'] = {
				['Background'] = Color3.fromRGB(15, 15, 20),
				['UIStroke'] = Color3.fromRGB(0, 200, 255),
			}
		}
	}
},
	...
	['Function'] = {
		['Toggle'] = {
			...
			['True'] = {
				['Toggle Background'] = Color3.fromRGB(40, 40, 40),
				['Toggle Value'] = Color3.fromRGB(100, 100, 100),
			},
			['False'] = {
				['Toggle Background'] = Color3.fromRGB(25, 25, 25),
				['Toggle Value'] = Color3.fromRGB(45, 45, 45),
			}
		},
		['Label'] = {
			['Background'] = Color3.fromRGB(20, 20, 20),
		...
		['Dropdown'] = {
			['Background'] = Color3.fromRGB(20, 20, 20),
			['Value Background'] = Color3.fromRGB(15, 15, 15),
			['Value Stroke'] = Color3.fromRGB(255, 255, 255),
			['Dropdown Select'] = {
				['Background'] = Color3.fromRGB(15, 15, 15),
				['Search'] = Color3.fromRGB(25, 25, 25),
				['Item Background'] = Color3.fromRGB(30, 30, 30),
			}
		},
		['Slider'] = {
			...
			['Value Stroke'] = Color3.fromRGB(230, 230, 230),
			['Slider Bar'] = Color3.fromRGB(40, 40, 40),
			['Slider Bar Value'] = Color3.fromRGB(90, 90, 90),
			['Circle Value'] = Color3.fromRGB(255, 255, 255)
		},
		['Code'] = {
			['Background'] = ColorSequence.new{
			...
			['Background Code'] = Color3.fromRGB(30, 30, 30),
			['Background Code Value'] = Color3.fromRGB(25, 25, 25),
			['ScrollingFrame Code'] = Color3.fromRGB(160, 160, 160)
		},
		['Button'] = {
			['Background'] = Color3.fromRGB(20, 20, 20),
			['Click'] = Color3.fromRGB(255, 255, 255)
	...
	['Page'] = Color3.fromRGB(16, 20, 30),
	['Main'] = Color3.fromRGB(60, 120, 200),
	['Text & Icon'] = Color3.fromRGB(235, 240, 255),
	['Function'] = {
		['Toggle'] = {
			['Background'] = Color3.fromRGB(20, 25, 35),
			['True'] = {
				['Toggle Background'] = Color3.fromRGB(50, 90, 160),
				['Toggle Value'] = Color3.fromRGB(100, 150, 255),
			},
			['False'] = {
				['Toggle Background'] = Color3.fromRGB(28, 30, 40),
				['Toggle Value'] = Color3.fromRGB(35, 40, 55),
			}
		},
		['Label'] = {
			['Background'] = Color3.fromRGB(20, 25, 35),
		...
		['Dropdown'] = {
			['Background'] = Color3.fromRGB(20, 25, 35),
			['Value Background'] = Color3.fromRGB(16, 20, 30),
			['Value Stroke'] = Color3.fromRGB(200, 220, 255),
			['Dropdown Select'] = {
				['Background'] = Color3.fromRGB(16, 20, 30),
				['Search'] = Color3.fromRGB(25, 30, 40),
				['Item Background'] = Color3.fromRGB(35, 40, 55),
			}
		},
		['Slider'] = {
			['Background'] = Color3.fromRGB(20, 25, 35),
			['Value Background'] = Color3.fromRGB(16, 20, 30),
			['Value Stroke'] = Color3.fromRGB(200, 220, 255),
			['Slider Bar'] = Color3.fromRGB(50, 90, 160),
		...
		['Code'] = {
			...
			['Background Code'] = Color3.fromRGB(45, 60, 80),
			['Background Code Value'] = Color3.fromRGB(35, 45, 65),
			['ScrollingFrame Code'] = Color3.fromRGB(100, 150, 255)
		},
		['Button'] = {
			['Background'] = Color3.fromRGB(20, 25, 35),
			['Click'] = Color3.fromRGB(255, 255, 255)
		...
		['Color Picker'] = {
			...
			['Color Select'] = {
				['Background'] = Color3.fromRGB(16, 20, 30),
				['UIStroke'] = Color3.fromRGB(200, 220, 255),
			}
		}
	}
},
	Velvet = {
	['Shadow'] = Color3.fromRGB(18, 16, 24),
	['Background'] = Color3.fromRGB(24, 22, 32),
	['Page'] = Color3.fromRGB(20, 18, 28),
	['Main'] = Color3.fromRGB(138, 95, 205),
	['Text & Icon'] = Color3.fromRGB(245, 240, 255),
	['Function'] = {
		['Toggle'] = {
			['Background'] = Color3.fromRGB(26, 24, 36),
			['True'] = {
				['Toggle Background'] = Color3.fromRGB(80, 60, 140),
				['Toggle Value'] = Color3.fromRGB(138, 95, 205),
			},
			['False'] = {
				['Toggle Background'] = Color3.fromRGB(36, 34, 48),
				['Toggle Value'] = Color3.fromRGB(52, 48, 66),
			}
		},
		['Label'] = {
			['Background'] = Color3.fromRGB(26, 24, 36),
		...
		['Dropdown'] = {
			['Background'] = Color3.fromRGB(26, 24, 36),
			['Value Background'] = Color3.fromRGB(20, 18, 28),
			['Value Stroke'] = Color3.fromRGB(200, 180, 255),
			['Dropdown Select'] = {
				['Background'] = Color3.fromRGB(20, 18, 28),
				['Search'] = Color3.fromRGB(30, 28, 42),
				['Item Background'] = Color3.fromRGB(40, 38, 55),
			}
		},
		['Slider'] = {
			['Background'] = Color3.fromRGB(26, 24, 36),
			['Value Background'] = Color3.fromRGB(20, 18, 28),
			['Value Stroke'] = Color3.fromRGB(220, 200, 255),
			['Slider Bar'] = Color3.fromRGB(80, 60, 140),
			['Slider Bar Value'] = Color3.fromRGB(138, 95, 205),
			['Circle Value'] = Color3.fromRGB(255, 255, 255)
		},
		['Code'] = {
			['Background'] = ColorSequence.new{
				ColorSequenceKeypoint.new(0, Color3.fromRGB(26, 24, 36)),
				ColorSequenceKeypoint.new(1, Color3.fromRGB(26, 24, 36))
			},
			['Background Code'] = Color3.fromRGB(55, 50, 78),
			['Background Code Value'] = Color3.fromRGB(42, 38, 60),
			['ScrollingFrame Code'] = Color3.fromRGB(160, 130, 220)
		},
		['Button'] = {
			['Background'] = Color3.fromRGB(26, 24, 36),
			['Click'] = Color3.fromRGB(245, 240, 255)
		},
		['Textbox'] = {
			['Background'] = Color3.fromRGB(26, 24, 36),
			['Value Background'] = Color3.fromRGB(20, 18, 28),
		...
		['Color Picker'] = {
			...
			['Color Select'] = {
				['Background'] = Color3.fromRGB(20, 18, 28),
				['UIStroke'] = Color3.fromRGB(220, 200, 255),
			}
		}
	}
}
...
function Library:Window(p)
	...
	--Minisize_1.LayoutOrder = 9e9
	--Minisize_1.Size = UDim2.new(0, 16,0, 16)
	--Minisize_1.Image = "rbxassetid://0"
	...
	Close_1.Image = "rbxassetid://122452709626741"
